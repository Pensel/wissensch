public class Test {
	...
	private static int[][] testNegativerCycle = { { 0, 1, 2, 0, 0 }, { 1, 0, -7, 5, 0 }, { 2, 3, 0, 0, 7 },
			{ 0, 5, 0, 0, 1 }, { 0, 0, 7, 1, 0 } };
	private static int[][] testNegativeKante = { { 0, -1, 5, 0, 0 }, { 1, 0, 3, 3, 0 }, { 5, 3, 0, 0, 2 },
			{ 0, 3, 0, 0, 6 }, { 0, 0, 2, 6, 0 } };
	...
	public static void main(String... args) {
		tester(testNegativerCycle, 0, "Negativer Zirkel");
